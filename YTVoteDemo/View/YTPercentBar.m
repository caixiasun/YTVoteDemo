...
#import <QuartzCore/QuartzCore.h>//为了使动画效果更好引入该头文件

@interface YTPercentBar()
...
- (void)progressBarTo:(CGFloat)value
{
    ...
    animation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];//动画速度：先慢后快再慢
